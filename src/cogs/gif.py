...
class Gif(commands.Cog):
    ...
    async def meidora1(self, ctx):
        ...
        await ctx.send(file=discord.File(SAVE_DIR+filename,filename))
    
    @commands.command(name='thx')
    async def meidora2(self, ctx):
        """メイドラゴンGIF"""
    ...
    @commands.command(name='onegai')
    async def meidora3(self, ctx):
        """メイドラゴンGIF"""
    ...
    @commands.command(name='gyu')
    async def meidora4(self, ctx):
        """メイドラゴンGIF"""
    ...
    @commands.command(name='maken')
    async def meidora5(self, ctx):
        """メイドラゴンGIF"""
    ...
    @commands.command(name='bohe')
    async def meidora6(self, ctx):
        """メイドラゴンGIF"""
